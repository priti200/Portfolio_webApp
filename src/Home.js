...
const Home = () => {
  ...
  return (
    <div className="w-full lgl:w-[100%] h-full lgl:h-[85%] bg-transparent text-white z-50 flex items-start justify-between p-4 lgl:p-0">
      {/* ================= Left Icons End here ======================== */}
      <div className="w-20 h-106 bg-transparent hidden lgl:flex flex-col gap-4">
        {/* ======= Home Icon start */}
        <div
        ...
        <div className="w-full h-80 bg-bodyColor rounded-3xl flex flex-col items-center justify-between py-6">
          ...
          <span
            ...
            className={`${
              about
                ? "text-designColor"
                : "w-full h-5 text-textColor text-xl flex items-center justify-center hover:text-designColor duration-300 cursor-pointer relative group"
          ...
          >
            <FaUser />
            <span className="text-black font-medium text-[14px] uppercase bg-designColor px-4 py-[1px] rounded-xl absolute left-0 translate-x-8 group-hover:translate-x-12 opacity-0 group-hover:opacity-100 transition-all duration-300 z-20">
              About
            </span>
          </span>
          {/* Resume Icon */}
      ...
      <div className="w-full lgl:w-[100%] h-full flex flex-col gap-6 lgl:gap-0 lgl:flex-row items-center">
